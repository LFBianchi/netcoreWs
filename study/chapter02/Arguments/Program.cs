...
namespace Arguments
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (args.Length < 4) 
            {
                WriteLine("You must specify 2 colors and 2 dimensions, e.g.:");
            ...
            {
                WriteLine("The current plaform does not support changing the size of a console window.");
            }
        }
    }
}
